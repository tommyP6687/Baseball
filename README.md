...
|<div align = "center" style = "width: 500px;"><img width="476" height="200" alt="missing-trackman" src="https://github.com/user-attachments/assets/ccf25660-3f68-426d-ab08-915e60b48ef0"/></div> | <div align = "center" style = "width: 500px;"><img width="479" height="202" alt="semi-missing-trackman" src="https://github.com/user-attachments/assets/1b8a6d2e-2e27-477e-894f-eb6294cff478"/></div>|
|:--:|:--:|
| *Example of final Excel sheet (mismatch in batter's name problem)* | *Example of final Excel sheet (after changing batter's name to match the Trackman file/s)* |
